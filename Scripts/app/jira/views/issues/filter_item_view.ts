...
/// <reference path="../../view_models/issues/filter_entry_view_model.ts" />
...
import FilterItemTemplate = require('app/jira/templates/issues/filter_item_template');
import template = require('app/jira/templates/issues/filter_item_view_template');
